...
const CourseInfoCard = ({ course }: { course: CourseWithGrades }) => {
  return (
    <div className="shadow-md  bg-card text-sm flex items-center justify-between border-[#27272a] rounded-lg  p-4 w-full max-w-md mx-auto">
      ...
      <div className="flex-grow flex items-center justify-center relative mx-4">
        ...
        <div className="font-semibold px-4">{truncateString(course.name)}</div>
